...
| 2026-06-05 | `specs/2026-06-05-local-persistence-completeness-design.md` | OPEN | Roadmap #4 decomposed → Phase 4b (local only): persist pinned-model buffer + spatial maps to IDB (v8→v9), shared `trimResult`, restore on project open; verify plots/equations restore. Local-by-default; opt-in cloud sync + E2EE is Phase 4a (later). Plan `plans/2026-06-05-local-persistence-completeness.md` (7 tasks). Claude track |

...
| 2026-06-01 | `plans/2026-06-01-ba-thesis-replication-roadmap.md` | IN PROGRESS | Phase 3 A1 (multi-FE Poisson) fully DONE — R-validated + browser-validated 2026-06-03. Descriptive viz B1/B2/B3 DONE 2026-06-09. A2/A3/A4 DONE 2026-06-09. B1/B2 still OPEN |
...
| 2026-06-07 | `specs/2026-06-07-design-language-refresh-design.md` | IN PROGRESS | UI upgrade Workstream A. T1–T9 complete + density T.*.fontSize tokens propagated to all 25 remaining files (Codex c339947 2026-06-09). Remaining: Task T9 DESIGN.md authoring (plain-text design doc for AI consistency anchor). |
| 2026-06-07 | `plans/2026-06-07-design-language-refresh.md` | IN PROGRESS | T1–T9 complete including density token migration. T10 (DESIGN.md + final validation) pending. |

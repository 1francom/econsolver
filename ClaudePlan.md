...
|------|-------------|--------|-------|
| 2026-07-02 | `specs/2026-07-02-calculate-limit-tool-design.md` | OPEN — awaiting Franco's spec review | Small additive feature from ClaudeFB.md 2026-06-19 "Add limits" — a 6th Calculate-tab tool (`lim`) computing numeric `lim(x→a) f(x)`, finite point or ±infinity, mirroring the existing Derivative tool's UI/engine pattern exactly. Executor: Claude Fable 5. |

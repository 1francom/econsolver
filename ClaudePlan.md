...
| 2026-06-04 | `specs/2026-06-04-ai-coach-persistence-streaming-design.md` | OPEN | Per-project persisted multi-conversation coach (IDB v6 `coach_chats`) + `streamClaude` streaming/stop in AIService.js + `api/anthropic.js` SSE pass-through |
| 2026-06-04 | `plans/2026-06-04-ai-coach-persistence-streaming.md` | OPEN | 9-task implementation plan for the coach persistence/streaming spec; lint+build+browser-validation gates (no JS test runner) |

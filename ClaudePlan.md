...
| 2026-06-07 | `specs/2026-06-07-design-language-refresh-design.md` | IN PROGRESS | UI upgrade Workstream A. Font switching works in Clean/Explore/Model. PENDING: (1) density (font-size scaling via T.* fontSize) not yet propagating to any module — components use hardcoded px sizes; (2) font migration for Simulate, Calculate, Report, Spatial modules (root containers + local atoms still use hardcoded mono). |
| 2026-06-07 | `plans/2026-06-07-design-language-refresh.md` | IN PROGRESS | T1–T9 complete. Font works Clean/Explore/Model. PENDING follow-ups tracked in spec row above. |

...
| 2026-05-31 | Data | Excel (.xlsx) import fails — SheetJS CDN dynamic import (`xlsx-0.20.3/package/xlsx.mjs`) throws "Failed to fetch" at runtime; likely CDN outage or COEP header blocking cross-origin module | high | data | `src/DataStudio.jsx` | open |
| 2026-05-31 | Data | OECD fetcher returns 406 Not Acceptable for SDMX datasets — Accept header sent does not match server-supported SDMX media types; needs `application/vnd.sdmx.data+json` Accept header update | medium | data | `src/services/data/fetchers/oecd.js` | open |

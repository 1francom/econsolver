...
export function generateStatInferenceScript(language, op, params = {}, result = {}) {
  ...
  // Long format first. It references the data (`t.test(y ~ treat, data = df)`)
  // instead of inlining every observation as a literal vector, which is what
  // the wide-format emitters below have to do.

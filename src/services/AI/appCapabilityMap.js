...
export const APP_CAPABILITY_MAP = {
  ...
  Explore:   { purpose: "Descriptive stats & plots", subtabs: {
                 ...
                 "Plot Builder": "layered charts (point/line/bar/histogram/density/smooth/boxplot/errorbar/ribbon/tile/h-line/v-line), facet_wrap by any column; data source is the dataset or a Goodman-Bacon 2x2 decomposition (pre-regression DiD diagnostic)" } },

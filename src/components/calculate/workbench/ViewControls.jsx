  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 6, marginBottom: 8, fontFamily: T.code.fontFamily }}>
      <div style={{ display: "flex", alignItems: "center", gap: 16, flexWrap: "wrap" }}>
        ...
        <label style={lbl(C, T)}>
          x min<input type="number" value={x0} onChange={(e) => setX(0, e.target.value)} style={num(C, T)} />
        </label>
        <label style={lbl(C, T)}>
          x max<input type="number" value={x1} onChange={(e) => setX(1, e.target.value)} style={num(C, T)} />
        </label>

        <label style={lbl(C, T)}>
          y min<input type="number" value={yr[0] ?? ""} placeholder="auto"
            onChange={(e) => setY(0, e.target.value)} style={num(C, T)} />
        </label>
        <label style={lbl(C, T)}>
          y max<input type="number" value={yr[1] ?? ""} placeholder="auto"
            onChange={(e) => setY(1, e.target.value)} style={num(C, T)} />
        </label>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 16, flexWrap: "wrap" }}>
        <label style={lbl(C, T)}>
          x label<input type="text" value={view.xLabel ?? ""} placeholder="x axis"
            onChange={(e) => onChange({ xLabel: e.target.value.slice(0, 48) })} style={{ ...num(C, T), width: 120 }} />
        </label>
        <label style={lbl(C, T)}>

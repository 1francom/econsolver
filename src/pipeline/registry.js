...
export const STEP_REGISTRY = [
...

  {
    ...
    category: "features",
    description: "Assign a value vector across all rows by a chosen mode: random (seeded weighted draw), distribution (draw from Normal/Uniform/Bernoulli/Poisson/Exponential/t/Chi-squared/Categorical/GroupID/CycleID), conditional (rules, each branch a literal or its own distribution), recycle (by position), or quota (exact proportions). Seeded for reproducible replay.",
    schema: [
      { key: "nn",     type: "text",   label: "Output column name" },
      { key: "values", type: "text",   label: "Values (comma or newline separated)" },
      { key: "mode",   type: "select", label: "Mode", options: [
        { value: "random",       label: "Random (weighted draw)" },
        { value: "distribution", label: "Distribution (statistical draw)" },
      ...
      { key: "dist",   type: "text",   label: "Distribution name (distribution mode)" },
      { key: "seed",   type: "number", label: "Random seed (any drawing mode)" },
    ],
...

  {
    ...
    schema: [
      { key: "rightId", type: "dataset", label: "Dataset to append" },
    ],
...

  {
    ...
    schema: [
      { key: "rightId", type: "dataset", label: "Dataset to bind" },
      { key: "suffix",  type: "text", label: "Suffix for duplicate columns (default: _r)" },
    ],
...

  {
    ...
    schema: [{ key: "rightId", type: "dataset", label: "Dataset to union" }],
...

  {
    ...
    schema: [{ key: "rightId", type: "dataset", label: "Other dataset" }],
...

  {
    ...
    schema: [
      ...
      { key: "lonCol",        type: "col",    label: "Longitude column" },
      { key: "outCol",        type: "text",   label: "Output column" },
      { key: "gridDatasetId", type: "dataset",   label: "Grid dataset id (existing mode)" },
...

  {
    ...
    schema: [
      { key: "latCol",        type: "col",  label: "Latitude column" },
      { key: "lonCol",        type: "col",  label: "Longitude column" },
      { key: "polyDatasetId", type: "dataset", label: "Polygon dataset id" },
...

  {
    ...
    schema: [
      { key: "latCol",       type: "col",     label: "Latitude column" },
      { key: "lonCol",       type: "col",     label: "Longitude column" },
      { key: "refDatasetId", type: "dataset",    label: "Reference dataset id (or \"self\")" },
...

  {
    ...
    schema: [
      { key: "latCol",        type: "col",  label: "Latitude column" },
      { key: "lonCol",        type: "col",  label: "Longitude column" },
      { key: "polyDatasetId", type: "dataset", label: "Boundary polygon dataset id" },
      { key: "wktCol",        type: "text", label: "Polygon WKT column" },
...

  {
    ...
    schema: [
      ...
      { key: "gridDatasetId", type: "dataset",   label: "Grid dataset id (grid_centroids mode)" },
...

  {
    ...
    schema: [
      ...
      { key: "bufferDatasetId", type: "dataset", label: "Buffer dataset id (or \"active\")" },
      { key: "gridDatasetId",   type: "dataset", label: "Grid dataset id (or \"active\")" },
...

  {
    ...
    schema: [
      ...
      { key: "gridDatasetId", type: "dataset", label: "Grid dataset id" },
...

  {
    ...
    schema: [
      { key: "srcDatasetId", type: "dataset",    label: "Source dataset id (or \"active\")" },
      { key: "tgtDatasetId", type: "dataset",    label: "Target dataset id (or \"active\")" },
